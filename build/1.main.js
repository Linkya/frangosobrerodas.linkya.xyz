webpackJsonp([1],Array(266).concat([
/* 266 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__about__ = __webpack_require__(407);
...
var AboutPage = (function () {
    ...
    AboutPage.prototype.loadAbout = function () {
        var _this = this;
        this.loading = this.loadingCtrl.create();
        this.loading.present().then(function () {
            _this.settingsService.get()
                .then(function (data) {
                _this.about = data;
    ...
    AboutPage.prototype.openSite = function (site) {
        window.open(site, '_blank');
    };
    AboutPage.prototype.loadOpeningTimes = function () {
        var _this = this;
