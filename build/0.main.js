...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__menu__ = __webpack_require__(416);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pipes_pipesmodule__ = __webpack_require__(403);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FormatCategoryPipe; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
 ...
 * Angular Pipes.
 */
var FormatCategoryPipe = (function () {
    function FormatCategoryPipe() {
    }
    /**
     * Takes a value and makes it lowercase.
     */
    FormatCategoryPipe.prototype.transform = function (value, args) {
        var newValue = "cat" + value;
        return newValue;
    };
    return FormatCategoryPipe;
}());
FormatCategoryPipe = __decorate([
...
//# sourceMappingURL=format-category.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__format_hour_format_hour__ = __webpack_require__(402);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__format_category_format_category__ = __webpack_require__(401);
...
PipesModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["a" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_2__format_category_format_category__["a" /* FormatCategoryPipe */]
        ],
        imports: [],
        exports: [
            __WEBPACK_IMPORTED_MODULE_1__format_hour_format_hour__["a" /* FormatHourPipe */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_menu_service__ = __webpack_require__(406);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_user_service__ = __webpack_require__(100);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_settings_service__ = __webpack_require__(398);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_cart_service__ = __webpack_require__(404);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_order_service__ = __webpack_require__(405);
...
var MenuPage = (function () {
    ...
    // 	this.local = local;
    // 	this.storage.get('local').then((value) => {
    // 		if(value && value != this.local) {
    // 			this.cleanCart();
    // 		}
    // 		this.storage.set('local', this.local);
    // 		this.loadMenu(this.local);
    // 	});
    // }
    MenuPage.prototype.cartSegment = function () {
        this.segment = 'cart';
    };
    MenuPage.prototype.addToCart = function (product, measure, menu) {
        var _this = this;
        product.menu = menu;
    ...
    MenuPage.prototype.addNote = function (product, i) {
        var _this = this;
        ...
        alert.addButton({
            ...
            handler: function (data) {
                _this.cart.items[i].note = data.note;
                _this.cartService.set(_this.cart);
            }
        });
        alert.present();
    };
    MenuPage.prototype.incrementQuantity = function (product) {
        ...
        this.cartService.incrementQuantity(product).then(function (cart) {
            var auxCategory;
            if (product.menu == 'fixed') {
                auxCategory = _this.fixedMenu.find(function (p) { return p.name === product.category; });
            }
            else {
    ...
    MenuPage.prototype.checkout = function (local) {
        var _this = this;
        this.loading = this.loadingCtrl.create();
        this.loading.present().then(function () {
