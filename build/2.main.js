...
var CheckoutPage = (function () {
    ...
    CheckoutPage.prototype.loadFees = function () {
        ...
        this.settingsService.getFees().then(function (value) {
            _this.order.fee = value.fixed_fee;
            _this.order.total += Number(_this.order.fee);
        }, function (error) {
        });
    };
